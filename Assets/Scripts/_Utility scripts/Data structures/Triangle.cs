...
namespace Habrador_Computational_Geometry
{
    ...
    public struct Triangle3
    {
        ...
        {
            this.p1 = new MyVector3(p1.x, p1.y, p1.z);
            this.p2 = new MyVector3(p2.x, p2.y, p2.z);
            this.p3 = new MyVector3(p3.x, p3.y, p3.z);
        }
        ...
        {
            float a = Vector3.Distance(p1.ToVector3(), p2.ToVector3());
            float b = Vector3.Distance(p2.ToVector3(), p3.ToVector3());
            float c = Vector3.Distance(p3.ToVector3(), p1.ToVector3());
