Shader "ARTEC/Parking"
{
    Properties
    {
        ...
        _StreetWidth ("Street Width", float) = 5
        _StreetAngle ("Street Angle", Range(0, 360)) = 0

        _VehicleWidth ("Vehicle Width", float) = 2
    ...
    SubShader
    {
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
            ...
            float isLine = step(p.x * _StreetWidth, _LineWidth);
            ...
            float isLine2 = step(p.y * _VehicleWidth, _LineWidth) * step(0,p.y);
            isLine = max(isLine, isLine2);

            isLine = isLine * step(streetW, 0.6);
            // if (streetW > 0.6) isLine = 0;
            ...
            c.rgb = lerp(c.rgb, _LineColor.rgb, isLine);
